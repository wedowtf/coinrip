      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <motion.div
            ...
            style={{ background: rank.color }}
            animate={{ scale: [1.1, 0.85, 1.1], opacity: [0.08, 0.15, 0.08] }}
        ...
        <div className="relative flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow: `0 0 10px ${rank.shadow}`,
              }}
          ...
          <div className="shrink-0 text-right">
            ...
            <motion.p
              ...
              style={{ color: '#E2FF00', textShadow: '0 0 12px rgba(226,255,0,0.7)' }}
              key={state.coinBalance}
              ...
              <div className="flex-1 h-1.5 bg-secondary rounded-full overflow-hidden">
                <motion.div
                  ...
                  style={{
                    ...
                    boxShadow: total > 0 && owned > 0 ? `0 0 6px ${shadow}` : 'none',
                  }}
                  initial={{ width: 0 }}
          ...
          <div className="flex gap-2.5 overflow-x-auto pb-1 -mx-1 px-1 scrollbar-none">
            {recentCoins.map((coin, i) => {
              ...
              return (
                ...
                >
                  <div
                    className="w-14 h-14 rounded-2xl flex items-center justify-center border overflow-hidden relative"
                    style={{
                      borderColor: meta.color + '50',
                      background: `linear-gradient(145deg, ${meta.color}18, #0A0A12)`,
                      boxShadow: `0 0 10px ${meta.shadow}`,
                    }}
                  >
                    <CoinLogo logoUrl={coin.logoUrl} name={coin.name} color={meta.color} />
                    {i === 0 && (
                      <div className="absolute top-0.5 right-0.5 w-2 h-2 rounded-full bg-primary animate-pulse" style={{ boxShadow: '0 0 6px rgba(226,255,0,0.8)' }} />
                    )}
                  </div>
                  <p className="text-[8px] font-bold text-center leading-tight text-zinc-400 truncate w-full">
                    {coin.name}
                  </p>
                  <div
      ...
      <div className="grid grid-cols-2 gap-3">
        {[
          ...
          <motion.button
            ...
            style={{
              background: `linear-gradient(145deg, ${item.color}0E, #0A0A12)`,
          ...
          {[
            ...
            <motion.div
              ...
              style={a.done ? {
                ...
                background: `linear-gradient(135deg, ${a.color}0E, #0A0A12)`,
                boxShadow: `0 0 12px ${a.color}12`,
              } : {
          ...
          <div className="p-5 relative" style={{ background: 'linear-gradient(155deg, #0F0F1E, #07070D)' }}>
            ...
            <div className="text-center space-y-4 py-3 relative z-10">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  className="flex-1 bg-red-500/15 text-red-400 border border-red-500/30 hover:bg-red-500/25 font-bold"
