...
import { LogOut, Package, LayoutGrid, Trophy, Zap, Star, Mail, Pencil } from "lucide-react";
    ...
    <div className="p-5 pb-28 flex flex-col gap-5">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <motion.button
                ...
                style={{
                  background: 'rgba(226,255,0,0.10)',
                  border: '1px solid rgba(226,255,0,0.22)',
                }}
                title="Change username"
              >
                <Pencil className="w-3 h-3" style={{ color: '#E2FF00' }} />
              </motion.button>
            </div>
      ...
      <div className="flex flex-col gap-2.5">
        ...
        <motion.button
          ...
          className="flex items-center justify-between border border-white/10 rounded-2xl px-4 py-3.5 text-sm font-bold hover:bg-white/4 transition-colors"
        >
          <div className="flex items-center gap-2.5 text-zinc-300">
            <div className="w-8 h-8 rounded-xl flex items-center justify-center"
              style={{ background: 'rgba(226,255,0,0.10)', border: '1px solid rgba(226,255,0,0.20)' }}>
              <Pencil className="w-3.5 h-3.5" style={{ color: '#E2FF00' }} />
            </div>
            <div className="text-left">
              <p className="text-sm font-bold text-white">Change Username</p>
              <p className="text-[10px] text-zinc-500">Currently: <span className="text-zinc-400 font-mono">{state.username}</span></p>
            </div>
          </div>
          <span className="text-[10px] font-black uppercase tracking-wider" style={{ color: '#E2FF00' }}>Edit →</span>
        </motion.button>
