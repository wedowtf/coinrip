...
function CoinMini({
  logoUrl, name, tierColor, ticker,
}: { logoUrl: string; name: string; tierColor: string; ticker: string }) {
    ...
    <div className="flex flex-col items-center gap-1">
      <div
        ...
        style={{
          ...
          background: `radial-gradient(circle, ${tierColor}28, ${tierColor}0C)`,
      ...
      <span
        className="text-[8px] font-black tracking-wide leading-none"
        style={{ color: tierColor, textShadow: `0 0 6px ${tierColor}80` }}
      >
        {ticker}
      </span>
    </div>
...
function PackCard({
  ...
  return (
    <div
      className="snap-center shrink-0 w-[280px] h-[480px] cursor-pointer"
      ...
      >
        ...
        >
          ...
          {pack.badgeLabel && (
            ...
            >{pack.badgeLabel}</motion.span>
          )}
          <div className="absolute top-4 left-4 z-10 flex items-center gap-1 opacity-35">
            <RotateCcw className="w-3 h-3 text-white" />
            <span className="text-[8px] text-white font-semibold uppercase tracking-wider">Rates</span>
          </div>
          ...
          <div
            ...
            style={{
              background: `linear-gradient(145deg, ${pack.color}18, ${pack.shadowColor} 130%)`,
          ...
          >
            ...
            <div className="flex items-center gap-1 flex-wrap justify-center pt-1 border-t border-white/5">
              {eligibleTiers.map(([tier]) => (
                <span key={tier}
                  className="text-[7px] font-black uppercase px-1.5 py-0.5 rounded-full leading-none"
                  style={{ backgroundColor: TIER_COLORS[tier as Tier] + "28", color: TIER_COLORS[tier as Tier] }}
                >
          ...
          <button
            ...
            style={{
              background: isAvailable ? `linear-gradient(135deg, ${pack.color}, ${pack.color}CC)` : "#1C1C26",
          ...
          >
            {isFree
              ...
              : <span className="flex items-center gap-1"><Lock className="w-3.5 h-3.5" /> {pack.cost} COINS</span>
            }
          </button>
        </div>
        ...
        >
          ...
          <motion.div
            ...
            style={{ background: `linear-gradient(108deg, transparent 33%, ${pack.color}20 50%, transparent 67%)` }}
            initial={{ x: "-100%" }} animate={{ x: "280%" }}
          ...
          <div className="z-10">
            <p className="text-[9px] font-bold uppercase tracking-widest opacity-60" style={{ color: pack.color }}>
              Drop rates · 6 coins per rip
            </p>
            <h3 className="font-display text-2xl font-black uppercase text-white"
              style={{ textShadow: `0 0 24px ${pack.color}80` }}>
              {pack.name}
            </h3>
          ...
          <div className="h-px w-full z-10"
            style={{ background: `linear-gradient(90deg, transparent, ${pack.color}55, transparent)` }} />

          <div className="z-10 flex flex-col gap-2.5 flex-1">
                ...
                <div key={tier} className="flex flex-col gap-1">
                  ...
                  <div className="h-1.5 rounded-full overflow-hidden" style={{ background: color + "18" }}>
                    <motion.div
                      ...
                      style={{ background: `linear-gradient(90deg, ${color}, ${color}99)`, boxShadow: `0 0 6px ${color}` }}
                      initial={{ width: 0 }}
    ...
    <div className="flex flex-col gap-5 pb-4">
      ...
      <div className="relative overflow-hidden px-6 pt-7 pb-3">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <motion.div className="absolute top-16 left-1/2 -translate-x-1/2 w-36 h-36 rounded-full blur-3xl"
        ...
        <motion.div className="text-center space-y-2 relative z-10"
          ...
          <motion.div className="inline-flex flex-col items-center">
            ...
            >CoinRip</motion.h1>
            <motion.div className="h-0.5 rounded-full mt-0.5"
              style={{ background: "linear-gradient(90deg, transparent, #E2FF00, transparent)" }}
              initial={{ width: 0 }} animate={{ width: "120px" }}
          ...
          >
            ...
            <div className="p-4 flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-display font-black text-black text-sm uppercase tracking-wide">
                  Welcome, {state.username}! 🎉
                </p>
                <p className="text-[11px] text-black/70 font-semibold mt-0.5">
                  <strong>+500 demo COINS</strong> — start ripping packs!
                </p>
              </div>
      ...
      <div className="flex flex-col gap-2 px-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[9px] text-zinc-500 italic">tap card → drop rates</span>
            <motion.span
